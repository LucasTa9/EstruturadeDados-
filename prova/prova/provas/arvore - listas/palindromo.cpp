...
int main(void)
{
    ...
    //percorrer os caracteres de uma palavra
    for(char c : palavra)
        inserirNoFim(c); //ou inserirNoInicio, a ordem de insercao nao altera a verificacao do palindromo
    ...
    //liberacao de memoria (opcional para a prova, mas boa pratica)
